...
@router_v1.get(path="/global", response_model=Union[List[DumpGlobalMetricSchema], DumpGlobalMetricSchema], summary='Получение метрики по дням', description="Ответ приходит в виде списка по дням в указанном диапазоне")
